                ...
                <div class="container mx-auto px-4 md:px-6">
                    <div class="text-center mb-12">
                        ...
                        <p class="max-w-[700px] mx-auto text-foreground-80 md:text-xl mt-4">
                            Panduan penting untuk memastikan keselamatan, efisiensi, dan integritas penelitian di
                            laboratorium kami.
                        </p>
                    </div>
                    ...
                    <div class="max-w-4xl mx-auto space-y-8">
                        ...
                        <div class="flex justify-center gap-4 mb-8">
                            <button id="select-solusi-btn"
                                class="inline-flex items-center justify-center rounded-md bg-blue-500 px-6 py-3 text-sm font-medium text-white shadow-sm transition-colors hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                                SOP Lab Solusi
                            </button>
                            <button id="select-msi-btn"
                                class="inline-flex items-center justify-center rounded-md bg-gray-300 px-6 py-3 text-sm font-medium text-gray-800 shadow-sm transition-colors hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                                SOP Lab MSI
                            </button>
                        </div>
                        ...
                        <!-- Download SOP Card -->
                        <div
                            class="rounded-lg border bg-white shadow-sm p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold">Dokumen SOP Laboratorium <span
                                            id="current-lab-name">Solusi</span></h2>
                                    <p class="text-sm text-muted-foreground">Setiap pengguna laboratorium wajib memahami
                                        dan mematuhi SOP yang berlaku.</p>
                                </div>
                            </div>
                            <button id="downloadPdfBtn"
                                class="w-full sm:w-auto inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    downloadPdfBtn.addEventListener('click', function() {
                        ...
                        doc.text(labSOP.title, doc.internal.pageSize.width / 2, y, {
                            align: 'center'
                        });
                        y += 15;
                        ...
                        labSOP.sections.forEach(section => {
                            ...
                            section.listItems.forEach(listItem => {
                                if (y > pageHeight -
                                    20) { // Check if new page is needed for list item
                                    doc.addPage();
                                    y = 15;
                                }
