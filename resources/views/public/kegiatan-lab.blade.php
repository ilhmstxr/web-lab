...
<body class="bg-gray-50 text-gray-800">
    ...
    <main class="py-20 relative z-10">
        <div class="container mx-auto px-6">
            ...
            @else
                <h2 class="text-3xl font-bold text-center text-blue-800 mb-10 fade-in-item" style="animation-delay: 0.1s;">
                ...
                <div class="mt-16 max-w-4xl mx-auto px-6 py-12 bg-blue-50 rounded-xl shadow-inner text-center fade-in-item">
