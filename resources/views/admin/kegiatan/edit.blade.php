    ...
    <main
        ...
        <div class="absolute inset-0 -z-10 opacity-30">
            <svg class="h-full w-full stroke-blue-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
                aria-hidden="true">
                <defs>
                    <pattern id="grid-pattern-edit" width="200" height="200" x="50%" y="-1" patternUnits="userSpaceOnUse">
                ...
                <rect width="100%" height="100%" stroke-width="0" fill="url(#grid-pattern-edit)" />
            </svg>
        </div>
        ...
        <div
            ...
            <h1 class="text-3xl sm:text-4xl font-extrabold text-blue-800 mb-8 text-center leading-tight">
                <span class="inline-block animate-wave-text">E</span>
                <span class="inline-block animate-wave-text delay-75">d</span>
                <span class="inline-block animate-wave-text delay-150">i</span>
                <span class="inline-block animate-wave-text delay-200">t</span>
                <span class="inline-block ml-2 animate-wave-text delay-250">K</span>
                <span class="inline-block animate-wave-text delay-300">e</span>
                <span class="inline-block animate-wave-text delay-350">g</span>
                <span class="inline-block animate-wave-text delay-400">i</span>
                <span class="inline-block animate-wave-text delay-450">a</span>
                <span class="inline-block animate-wave-text delay-500">t</span>
                <span class="inline-block animate-wave-text delay-550">a</span>
                <span class="inline-block animate-wave-text delay-600">n</span>
            </h1>
            ...
            <form method="POST" action="{{ route('kegiatan.update', $kegiatan) }}" enctype="multipart/form-data"
                ...
                <div class="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
                    <button type="submit"
                        class="inline-flex items-center justify-center gap-3 px-10 py-4 bg-gradient-to-r from-green-500 to-teal-600 text-white font-bold text-lg rounded-full shadow-xl hover:shadow-2xl hover:from-green-600 hover:to-teal-700 transition duration-400 ease-in-out transform hover:-translate-y-1 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-green-400 focus:ring-offset-2 focus:ring-opacity-75 relative overflow-hidden group w-full sm:w-auto">
                        <span
                            class="absolute right-0 top-0 h-full w-8 -mt-2 -mr-2 bg-green-700 transform rotate-45 opacity-0 group-hover:opacity-100 transition-all duration-300"></span>
